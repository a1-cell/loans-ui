<template>
  <div>
    ...
    <el-dialog title="发布的公告" :visible.sync="dialogFormVisible" width="40%" >
...
export default {
  ...
  methods: {
    load() {
      axios.get("http://localhost:9111/notice/page"
      //     {
      //   params: {
    ...
    save() {
      axios.post("http://localhost:9111/notice/save", this.form).then(res => {
        if (res) {
